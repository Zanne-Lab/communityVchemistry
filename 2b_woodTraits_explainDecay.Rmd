...
2. CODE-S2. Test role of wood substrate attributes. Include C fraction data, exclude small stems.
3. STEM-S1. Test role of wood substrate attributes. Exclude C fraction data, include small stems.
4. STEM-S2. Test role of wood substrate attributes. Include C fraction data, exclude small stems.
...
___________________
# 2. CODE-Slice2 (C2). Test role of wood substrate attributes. Include C fraction data, exclude small stems.
...
result.traitsDecay$models %>%
  ...
  dplyr::rename('resp'='source') %>%
  filter(term != "Residuals") -> fit.df
# remove fit data for empty model
fit.df %>%
  filter(resp != "time25") -> fit.df
coef.df %>%
  left_join(fit.df) -> plot.df
