...
plots_explainDecay.list$traits.code$plots.water[[1]]
dev.off()

### ca
pdf(file = "output/unknown/traits-code_explainDecay_ca.pdf")
plots_explainDecay.list$traits.code$plots.ca[[1]]
dev.off()
