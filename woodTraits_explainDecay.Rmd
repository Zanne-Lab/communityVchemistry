...
fig <- makefig__traits_explain_decayParams(decayfits, traits.code, 
                                            ...
                                            use.cache = T, save.cache = T, cfract = F) 
...
resids_explainDecay.list[['traits.stem']] <- doAnalysis_traits_explain_pmr(datasets, 
                              stem.respVars, traitVars.stem, 
                              use.cache = T, save.cache = T)# this fxn is called in the makefig fxn above
...
fig <- makefig__traits_explain_decayParams(decayfits, 
                                           ...
                                           use.cache = T, save.cache = T, cfract = T)
fig$p
fig$p.r2
...
fig <- makefig__traits_explain_decayParams(decayfits, 
                                           ...
                                           use.cache = F, save.cache = F, cfract = T) #
fig$p
fig$p.r2
...
resids_explainDecay.list[['cfract.stem']] <- doAnalysis_cfract_explain_pmr(datasets,
                                                                           stem.respVars,
                                                                           traitVars.cfract,
                                                                           use.cache = T, save.cache = T)# this fxn is called in the makefig fxn above
