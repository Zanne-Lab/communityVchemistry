...
write_csv(decayfits,"derived_data/decayfits2.csv")
decayfits <- read_csv("derived_data/decayfits2.csv")
...
```{r}
makefig__traits_explain_decayParams(decayfits, traits.code,code.respVars,use.cache = F) # output/figures/maintext/traits_explain_decayparams.pdf
