...
fit.tr.r2 <- WAPLS(meanOTUabund.trim, trait.residuals$ne.r2)
fit.tr.k <- WAPLS(meanOTUabund.trim, spdf.trim$k)
fit.tr.alpha <- WAPLS(meanOTUabund.trim, spdf.trim$alpha)
