...
pdf(file = "output/figures/compare_t50.pdf", width = 6, height = 6)
...
pdf(file = "output/figures/decayfits.pdf", width = 8, height = 8)
...
p
ggsave(filename = "output/figures/pmr_byStem.pdf", plot = p, width=6, height=6)
```
